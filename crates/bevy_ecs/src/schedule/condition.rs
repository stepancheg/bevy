...
///
/// `Marker` type parameter in return type can be set to `<()>` with help of
/// [`IntoSystem::into_system`], but usually have to be specified when passing
/// a condition to a function.
///
/// ```
